...
static inline void divrem_u64_u32_u64_u32(uint64_t* out_q, uint32_t* out_r, uint64_t in_n, uint32_t in_d) {
    uint32_t* out_q32 = (uint32_t*)out_q;
    uint32_t* in_n32 = (uint32_t*)&in_n;
    asm(
        // divide high word of n by d
        "movl %4, %%eax\n\t"
        "xorl %%edx, %%edx\n\t"
        "divl %5\n\t"
...
void divrem_u128_u128_u128_u128(u128_t* out_q, u128_t* out_r, const u128_t* n, const u128_t* d) {
    int di;
    int ri;
    uint32_t hd;
    uint64_t hr;
...
static inline void divrem_u128_u64_u128_u64(u128_t* out_q, uint64_t* out_r, const u128_t* n, const uint64_t d) {
    if (n->v1 < d) {
