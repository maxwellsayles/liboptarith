 ...
 */
int32_t gcdext_blockbinary_s32(int32_t* out_s, int32_t* out_t, int32_t in_u, int32_t in_v) {
    int32_t u1, u2, u3;
    int32_t v2, v3;
    int32_t u, v;
    int b;
 ...
 * Output: g, s, t  such that g = s*u + t*v
 */
int32_t gcdext_binary_s32(int32_t* out_s, int32_t* out_t, int32_t in_u, int32_t in_v) {
    int32_t u1, u2, u3;
    int32_t v2, v3;
    int32_t u, v;
    int b;
